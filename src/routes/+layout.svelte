<script>
	...
	$: backgroundImage = $page.url.pathname.startsWith('/quiz')
...
<div class="background" style="background-image: url({backgroundImage});">
	<main class="flex flex-col justify-center items-center gap-3 p-10 md:p-20 min-h-screen max-w-5xl mx-auto">
		<slot></slot>
	</main>
</div>
